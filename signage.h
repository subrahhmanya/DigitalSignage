...
private:
	...
	/* Board Specific Vars */
	bool validConfig[64];
	int tEn[64], tPX[64], tPY[64], tSc[64], tBr[64], tW[64], tH[64], tBt[64], tA[64], tTs[64], tDuration[64][64], tSType[64][64], tBC[64], tBR[64], tOR[64], pFade[64], aDuration[64], aSType[64], aActive[64];
